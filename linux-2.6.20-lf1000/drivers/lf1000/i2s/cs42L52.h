...
u8 cs42L52_reg4_settings[] = {
	...
	0xAA,	// index [0], older board, set at compile time
	...
	0xAA,	// index [1], rev 1 not used, set both SPK/HP on
	0xAA,	// index [2], rev 2 not used, set both SPK/HP on
...
u8 cs42L52_reg26_settings[][2] = {
	/* <jack_low>, <jack_high> */
#if defined (CONFIG_MACH_LF_MP2530F)
	{0x00, 0x50},	// index [0], older board, set at compile time
#elif defined (CONFIG_MACH_ME_LF1000)
	...
	{0x00, 0x05},	// index [1], rev 1 not used
	{0x00, 0x05},	// index [2], rev 2 not used
...
int detectSpeaker[] = {
        /* VALUE*/
#if defined (CONFIG_MACH_LF_MP2530F)
        0x0,   // index [0], older board, set at compile time
#elif defined (CONFIG_MACH_ME_LF1000)
        ...
        0x0,   // index [1], rev 1 not used, set both SPK/HP on
        0x0,   // index [2], rev 2 not used, set both SPK/HP on
