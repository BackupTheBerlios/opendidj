...
#define LCD_BACKLIGHT_VIRT_DEFAULT	-11

/* timing and pin map */
#define NUM_PVD_PINS 24
#ifdef CONFIG_MACH_ME_MP2530F /* NaviBoard */
	...
	#define DPC_DESIRED_CLOCK_HZ			25000000
	#define DISPLAY_VID_PRI_PAD_VCLK		VID_PADVCLK_VCLK
	#define DISPLAY_VID_PRI_VCLK_DELAY		0
	#define DISPLAY_VID_PRI_VCLK_INV		0
	#define DISPLAY_VID_PRI_VCLK_OUT_ENB		0
	#define DISPLAY_VID_PRI_VCLK2_DIV		0
	#define DISPLAY_VID_PRI_MAX_X_RESOLUTION	800
	#define DISPLAY_VID_PRI_MAX_Y_RESOLUTION	480
	#define DISPLAY_VID_PRI_HSYNC_SWIDTH		2
	#define DISPLAY_VID_PRI_HSYNC_FRONT_PORCH	8
	#define DISPLAY_VID_PRI_HSYNC_BACK_PORCH	14
	#define DISPLAY_VID_PRI_HSYNC_ACTIVEHIGH	0
	#define DISPLAY_VID_PRI_VSYNC_SWIDTH		3
	#define DISPLAY_VID_PRI_VSYNC_FRONT_PORCH	5
	#define DISPLAY_VID_PRI_VSYNC_BACK_PORCH	5
...
static char pvd_pins[NUM_PVD_PINS] = {
	...
	GPIO_PIN12, GPIO_PIN13, GPIO_PIN14, GPIO_PIN15, GPIO_PIN16,
	GPIO_PIN17, GPIO_PIN18, GPIO_PIN19, GPIO_PIN20, GPIO_PIN21, GPIO_PIN22,
	GPIO_PIN23
};

static char pvd_ports[NUM_PVD_PINS] = {
	GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A,
	GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A,
	GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A,
	GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, GPIO_PORT_A, 
};
...
static char pvd_ports[NUM_PVD_PINS] = {
...
#else /* Leapfrog 2530 dev boards */
	#define DISPLAY_VID_PRI_VCLK_SOURCE		VID_VCLK_SOURCE_PLL1
	#define DISPLAY_VID_PRI_VCLK2_SOURCE		VID_VCLK_SOURCE_VCLK2
	#define DISPLAY_VID_PRI_SWAP_RGB		0
	#define DPC_DESIRED_CLOCK_HZ			6000000
	#define DISPLAY_VID_PRI_PAD_VCLK		VID_PADVCLK_nVCLK
	#define DISPLAY_VID_PRI_VCLK_DELAY		0
	#define DISPLAY_VID_PRI_VCLK_INV		1
	#define DISPLAY_VID_PRI_VCLK_OUT_ENB		0
	#define DISPLAY_VID_PRI_VCLK2_DIV		0
	#define DISPLAY_VID_PRI_MAX_X_RESOLUTION	320
	#define DISPLAY_VID_PRI_MAX_Y_RESOLUTION	240
	#define DISPLAY_VID_PRI_HSYNC_SWIDTH		1
	#define DISPLAY_VID_PRI_HSYNC_FRONT_PORCH	50
	#define DISPLAY_VID_PRI_HSYNC_BACK_PORCH	38
	#define DISPLAY_VID_PRI_HSYNC_ACTIVEHIGH	1
	#define DISPLAY_VID_PRI_VSYNC_SWIDTH		1
	#define DISPLAY_VID_PRI_VSYNC_FRONT_PORCH	4
	#define DISPLAY_VID_PRI_VSYNC_BACK_PORCH	18
	#define DISPLAY_VID_PRI_VSYNC_ACTIVEHIGH	1
